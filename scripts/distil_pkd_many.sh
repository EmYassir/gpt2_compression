...
export N_GPU_NODE=8
export WORLD_SIZE=$(N_NODES*N_GPU_NODE)
export MASTER_PORT=$((((RANDOM<<15)|RANDOM)%63001+3000))
export OMP_NUM_THREADS=8

## Deepspeed 
export INCLUDE="localhost:0,1,2,3,4,5,6,7@10.193.241.128:0,1,2,3,4,5,6,7@10.218.4.37:0,1,2,3,4,5,6,7"
export DS_HOSTFILE=/home/yassir/gpt2-kd/deepspeed_cfg/hostfile_many
...
export OUTPUT_DIR=/media/data/yassir/output/pkd_distillation/test/
