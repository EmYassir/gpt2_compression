...
## Deepspeed
export INCLUDE="localhost:0,1,2,3"
...
export MODEL_PATH=/media/data/yassir/truncated_models/$MODEL_TYPE-medium


## Training settings
export RUNNER=/home/yassir/gpt2-kd/runners/run_clm.py
export OUTPUT_DIR=/media/nvme/yassir/output/truncated_models/$MODEL_TYPE-medium
