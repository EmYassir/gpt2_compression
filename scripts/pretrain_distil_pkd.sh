...
export OUTPUT_DIR=/media/nvme/yassir/output/pkd_distillation/pretraining/

## TRAINING DATA
export DATA_DIR=/media/nvme/yassir/datasets/openwebtext/grouped_full
...
export BETA_PKD=0.2
export PKD_OUTPUT=0
export LEARNING_RATE=2.5e-4
export LOG_INTERVAL=2000
export CKPT_INTERVAL=60000
