...
from utilities.loss_objects import CustomLabelSmoother2, smoothen_loss
...
class CustomTrainer:
    ...
    def __init__(
        ...
        if self.args.label_smoothing_factor != 0:
            ...
            #self.label_smoother = CustomLabelSmoother2(epsilon=self.args.label_smoothing_factor)
            self.label_smoother = smoothen_loss
        else:
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        if labels is not None:
            ...
            loss = smoothen_loss(outputs, self.args.label_smoothing_factor)
        else:
